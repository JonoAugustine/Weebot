...
package com.ampro.weebot.bot.commands.moderation

import com.ampro.weebot.WAITER
import com.ampro.weebot.Weebot
import com.ampro.weebot.bot.commands.moderation.VCRoleManager.Limit.ALL
import com.ampro.weebot.bot.commands.moderation.VCRoleManager.Limit.PUBLIC
            ...
            fun chooseCategory(message: Message, vcg: VCGenerator) {
                SelectablePaginator(setOf(event.author), singleUse = true,
                    title = "VCGenerator Base Channel Chosen!", description = """
                        ...
                        Reacting with $X_Red to this note will set generate VCs in
            ...
            fun chooseChannel(message: Message) {
                SelectablePaginator(setOf(event.author), singleUse = true,
                    title = "Voice Channel Generator Enabled!", description = """
                            ...
                            generate a new VC by reacting with $X_Red to this note.
                        """.trimIndent(),
